...
import dk.nelind.avail.gui.widget.DocDisplayWidget;

public class HomeScreen extends AvailScreen {
    public HomeScreen() {
        super(Text.of("Avail Home Screen"));
    }

    @SuppressWarnings("unused")
    private final String FORMAT_TEXT_TEST = """
        {"text": "· §0Test§r  §0§kTest§r  §0§lTest§r  §0§lTest§r  §0§mTest§r  §0§nTest§r  §0§oTest§r
